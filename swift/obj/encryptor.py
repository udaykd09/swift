...
import M2Crypto
from swift.common.storage_policy import POLICIES, ENCRYPTION_POLICY
...
class M2CryptoDriver(CryptoDriver):
    ...
    def encryption_context(self):
        ...
        :returns: encryption context
        """
        context = super(M2CryptoDriver, self).encryption_context()
        #TODO(uday): IV hardcoded now it will be generated and stored
        #               into key manager.
        context.update({
